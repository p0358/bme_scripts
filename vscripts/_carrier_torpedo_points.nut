...
function GetTorpedoOffset( origin, angles, indexStart, torpedoPoints )
{
	...
	local pointAngles = point.angles.AnglesCompose( angles )

	local pointForward = pointAngles.AnglesToForward()
	local dist = RandomFloat( 1800, 5000 )
