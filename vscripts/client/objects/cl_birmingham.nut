...
function main()
{
	ModelFX_BeginData( "thrusters", "models/vehicle/capital_ship_Birmingham/birmingham_fleetScale.mdl", "all", true )
		//----------------------
		// Thrusters
		//----------------------
			...
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_5", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_6", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_7", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_8", "veh_redeye_round_jet_FULL" )
			...
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_5", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_6", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_7", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_8", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_LG_1", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_LG_2", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_LG_3", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "L_Exhaust_Rear_LG_4", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_LG_1", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_LG_2", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_LG_3", "veh_redeye_round_jet_FULL" )
			ModelFX_AddTagSpawnFX( "R_Exhaust_Rear_LG_4", "veh_redeye_round_jet_FULL" )


	ModelFX_EndData()


//	ModelFX_BeginData( "running_lights", "models/capital_ship_Birmingham/birmingham.mdl", "all", true )
//		//----------------------
//		// ACL Lights
//		//----------------------
