function main()
{
	ModelFX_BeginData( "titanHealth", STRYDER_MODEL, "notLocalPlayer", true )
	...
	ModelFX_BeginData( "titanDoomed", STRYDER_MODEL, "notLocalPlayer", false )
	...
	ModelFX_BeginData( "titanDamage", STRYDER_MODEL, "notLocalPlayer", true )
		...
		ModelFX_AddTagBreakGib( 1, "exp_L_shoulder", "models/gibs/titan_gibs/stry_gib9_l_bicep1.mdl", GIBTYPE_DEATH, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "exp_R_elbow", "models/gibs/titan_gibs/stry_gib9_l_bicep1.mdl", GIBTYPE_DEATH, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "dam_L_thigh_front", "models/gibs/titan_gibs/stry_gib8_l_thigh1.mdl", GIBTYPE_NORMAL, 400, 500 )

		ModelFX_AddTagDamageFX( 1, "dam_L_thigh_side", "xo_spark_med", 1.5, 6.0, "titan_damage_spark" )
		ModelFX_AddTagBreakGib( 1, "dam_L_thigh_side", "models/gibs/titan_gibs/stry_gib8_l_thigh2.mdl", GIBTYPE_NORMAL, 400, 500 )

		ModelFX_AddTagDamageFX( 1, "dam_L_thigh_back", "xo_spark_med", 1.5, 6.0, "titan_damage_spark" )
		ModelFX_AddTagBreakGib( 1, "dam_L_thigh_back", "models/gibs/titan_gibs/stry_gib1.mdl", GIBTYPE_NORMAL, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "exp_R_thigh", "models/gibs/titan_gibs/stry_gib8_l_thigh1.mdl", GIBTYPE_NORMAL, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "exp_R_knee", "models/gibs/titan_gibs/stry_gib7_r_shin.mdl", GIBTYPE_DEATH, 400, 500 )

		//Death Explosion FX
		ModelFX_AddTagBreakGib( 2, "exp_torso_front", "models/gibs/titan_gibs/stry_gib_hatch_d.mdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_L_shoulder", "models/gibs/titan_gibs/stry_gib_l_arm1_d.mdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_L_elbow", "models/gibs/titan_gibs/stry_gib_l_arm2_d.mdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_R_shoulder", "models/gibs/titan_gibs/stry_gib_r_arm1_d.mdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_R_elbow", "models/gibs/titan_gibs/stry_gib_r_arm2_d.mdl", GIBTYPE_DEATH, 600, 800 )
