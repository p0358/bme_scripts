...
function main()
{
	ModelFX_BeginData( "friend_lights", "models/vehicle/goblin_dropship/goblin_dropship_hero.mdl", "friend", true )
		//----------------------
		// ACL Lights - Friend
		//----------------------
	...
	ModelFX_BeginData( "foe_lights", "models/vehicle/goblin_dropship/goblin_dropship_hero.mdl", "foe", true )
		//----------------------
		// ACL Lights - Foe
		//----------------------
	...
	ModelFX_BeginData( "interior_lights", "models/vehicle/goblin_dropship/goblin_dropship_hero.mdl", "friend", true )
		//----------------------
		// Interior Lights -
		//----------------------
		ModelFX_AddTagSpawnFX( "int_light_glow01",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow02",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow03",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow04",		"veh_int_light_blue" )
		//ModelFX_AddTagSpawnFX( "int_light_glow05",		"veh_int_light_blue" )
		//ModelFX_AddTagSpawnFX( "int_light_glow06",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow07",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow08",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow09",		"veh_int_light_blue" )
		ModelFX_AddTagSpawnFX( "int_light_glow10",		"veh_int_light_blue" )
	ModelFX_EndData()

	/*
	ModelFX_BeginData( "cargo_lights", "models/vehicle/goblin_dropship/goblin_dropship_hero.mdl", "friend", true )
		//----------------------
		// Cargo Lights
		//----------------------
	...
	*/
	...
	ModelFX_BeginData( "thrusters", "models/vehicle/goblin_dropship/goblin_dropship_hero.mdl", "all", true )
		//----------------------
		// Thrusters
		//----------------------
	...
	ModelFX_BeginData( "dropshipDamage", "models/vehicle/goblin_dropship/goblin_dropship_hero.mdl", "all", true )
		//----------------------
		// Health effects
		//----------------------
...
/*
	ModelFX_BeginData( "dropshipCrash", "models/vehicle/goblin_dropship/goblin_dropship_hero_dest_center.mdl", "all", true )
		//----------------------
