function main()
{
	ModelFX_BeginData( "titanHealth", OGRE_MODEL, "notLocalPlayer", true )
	...
	ModelFX_BeginData( "titanDoomed", OGRE_MODEL, "notLocalPlayer", false )
		ModelFX_AddTagHealthFXAndSound( 1.0, "dam_vents", "xo_health_fire_vent_doom", false, "titan_damage_large_fire_loop", "titan_damage_large_fire_start" )
	...
	ModelFX_BeginData( "titanDamage", OGRE_MODEL, "notLocalPlayer", true )
