...
function main()
{
	...
	ModelFX_BeginData( "thrusters", "models/vehicle/imc_bomber/bomber.mdl", "all", true )
		//----------------------
		// Thrusters
		//----------------------
	...
	ModelFX_BeginData( "dropshipDamage", "models/vehicle/imc_bomber/bomber.mdl", "all", true )
		//----------------------
		// Health effects
		//----------------------
	...
	// ModelFX_BeginData( "dropshipExplode", "models/vehicle/imc_bomber/bomber.mdl", "all", true )
	// 	//----------------------
	// 	// Death effects
	// 	//----------------------
