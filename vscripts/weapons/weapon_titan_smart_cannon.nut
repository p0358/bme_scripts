SetWeaponSound( "fire", "Weapon_smartrifle.Fire" )
...
function OnWeaponActivate( activateParams )
{
	...
	{
		// old usage
		//SmartAmmo_SetEffectiveRange( self, 500, 2500 )
		//SmartAmmo_SetTargetingDelay( self, 0.2 )
		//SmartAmmo_SetTitanUseAllowed( self, true )
		//SmartAmmo_Start( self, false )
	}
