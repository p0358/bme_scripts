...
function RegisterEvacConversations()
{
	...
	/**************************        IMC        *****************************/
	local convRef = AddConversation( "WonAnnouncementWithEvac", TEAM_IMC )
	...
	/**************************  WonAnnouncementWithEvac  *****************************/
	/**************************      MILITIA      *****************************/
	local convRef = AddConversation( "WonAnnouncementWithEvac", TEAM_MILITIA )
	...
	local convRef = AddConversation( "LostAnnouncementWithEvac", TEAM_MILITIA )
	...
	local convRef = AddConversation( "LostAnnouncementWithEvac", TEAM_IMC )
